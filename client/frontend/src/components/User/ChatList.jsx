...
function ChatList({userChatList,get_id}) {
    let {user} = useContext(AuthContext) 
    return (
        <div>
          <section class="antialiased bg-gray-50 text-gray-600 min-h-[90vh] p-4">
            <div class="h-full">
                  ...
                  <div class="divide-y divide-gray-200">
                    ...
                    <button class="w-full text-left py-2 focus:outline-none focus-visible:bg-indigo-50">
                      <div class="flex items-center">
                        ...
                        <div>
                          <h4 class="text-sm font-semibold text-gray-900" onClick={()=>get_id(list.id,list.username)} >
                           {list.username} 
                          </h4>
